...
public class FarmerSignupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignup.setOnClickListener(v -> {
            ...
            long id = dbHelper.insertFarmer(name, birthday, email, contact, address, password, 0.0, 0.0);
            ...
            if(id > 0){
                ...
                startActivity(new Intent(FarmerSignupActivity.this, FarmerDashboardActivity.class));
                finish();
            } else {
